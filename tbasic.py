...
[31]  apt install figlet -y
  ...
  os.system('xdg-open https://t.me/tcorporation69termux')
elif mo == '4':
  os.system('xdg-open https://github.com/T-CORPORATION-69')
elif mo == '5':
  os.system('exit')
